...
--
-- Name: elements name_u; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements symbol_u; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT symbol_u UNIQUE (symbol);
